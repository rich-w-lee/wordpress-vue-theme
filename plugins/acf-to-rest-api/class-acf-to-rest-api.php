...
if ( ! class_exists( 'ACF_To_REST_API' ) ) {
	...
	function ACF_To_REST_API() {
	
		// globals
		global $ACF_To_REST_API;
		
		
		// initialize
		if( !isset($ACF_To_REST_API) ) {
			$ACF_To_REST_API = new ACF_To_REST_API();
			$ACF_To_REST_API->init();
		}
		
		
		// return
		return $ACF_To_REST_API;
